...
//   return (
//     <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-md">
...
const Header = ({ onLogout }) => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 text-white">
      {/* Heading */}
      <h1 className="text-2xl font-semibold">Data Crarts Decor</h1>
